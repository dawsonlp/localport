...
from ..value_objects.discovery import DiscoveredPort, KubernetesResource
...
class KubernetesDiscoveryRepository(ABC):
    ...
    async def find_resource(
        self, name: str, namespace: str | None = None, resource_type: str = "service"
    ...
    async def search_all_namespaces(
        self, resource_name: str, resource_type: str = "service"
    ...
    async def resource_exists(
        self, name: str, namespace: str, resource_type: str = "service"
    ) -> bool:
