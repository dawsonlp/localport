...
from .base_adapter import PortForwardingAdapter, AdapterNotAvailableError
...
class AdapterFactory:
    ...
    async def create_adapter(self, adapter_type: str) -> Optional[PortForwardingAdapter]:
    ...
    async def get_adapter(self, technology: ForwardingTechnology) -> Optional[PortForwardingAdapter]:
...
async def create_adapter(adapter_type: str) -> Optional[PortForwardingAdapter]:
...
async def get_adapter_for_technology(technology: ForwardingTechnology) -> Optional[PortForwardingAdapter]:
    """Get an adapter for a specific forwarding technology.
