...
class AddConnectionRequest:
    ...
    def kubectl_request(
        ...
        **kwargs: Any,
        ...
        options = {"local_port": local_port, **kwargs}
    ...
    def ssh_request(
        ...
        **kwargs: Any,
        ...
        options = {"local_port": local_port, "remote_port": remote_port, **kwargs}
...
class AddConnectionResponse:
    ...
    discovered_info: dict[str, Any] | None = None
    ...
    def failure_response(
        cls, service_name: str, message: str, warnings: list[str] = None
    ) -> "AddConnectionResponse":
...
class RemoveConnectionResponse:
    ...
    @classmethod
    def failure_response(
        cls, service_name: str, message: str
    ) -> "RemoveConnectionResponse":
        """Create a failure response."""
        return cls(
            success=False,
...
class ListConnectionsResponse:
    ...
    @classmethod
    def success_response(
        cls, services: list[ServiceSummary], message: str = ""
    ...
    @classmethod
    def failure_response(cls, message: str) -> "ListConnectionsResponse":
        """Create a failure response."""
        return cls(
            success=False,
            services=[],
...
class DiscoveryResult:
    ...
    @classmethod
    def not_found(cls, warnings: list[str] = None) -> "DiscoveryResult":
        """Create a not found result."""
        return cls(found=False, warnings=warnings or [])
    ...
    def found_multiple_namespaces(
        cls, namespaces: list[str], warnings: list[str] = None
    ) -> "DiscoveryResult":
        """Create a result for a resource found in multiple namespaces."""
        return cls(found=True, multiple_namespaces=namespaces, warnings=warnings or [])
    ...
    def needs_port_selection(self) -> bool:
        ...
        return (
            ...
            and len(self.resource.available_ports) > 1
            and self.selected_port is None
        )
