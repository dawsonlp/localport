...
from .configuration_differ import ConfigurationDiffer, ConfigurationDiff
...
class ConfigurationManager:
    ...
    async def start_hot_reloading(
        ...
        reload_callback: Optional[Callable[[ConfigurationDiff], None]] = None
    ) -> bool:
    ...
    async def reload_configuration(self, force: bool = False) -> Optional[ConfigurationDiff]:
    ...
    async def _reload_config_internal(self, force: bool = False) -> Optional[ConfigurationDiff]:
    ...
    async def get_current_configuration(self) -> Optional[Dict[str, Any]]:
    ...
    async def backup_current_configuration(self, backup_path: Optional[str] = None) -> Optional[str]:
