...
from ...domain.entities.health_check import HealthCheck, HealthCheckStatus
...
class HealthMonitorScheduler:
    ...
    async def stop_monitoring(self, service_ids: Optional[Set[UUID]] = None) -> None:
    ...
    def get_health_status(self, service_id: UUID) -> Optional[HealthCheckResult]:
