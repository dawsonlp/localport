...
from ..dto.service_dto import ServiceMonitorResult, HealthCheckInfo
...
class HealthMonitor:
    ...
    async def start_monitoring(self, services: Optional[List[Service]] = None) -> None:
    ...
    async def get_health_status(self, service_id: UUID) -> Optional[HealthCheckInfo]:
