...
class TestErrorFormatting:
    ...
    def test_ssh_key_not_found_normal_verbosity(self):
        ...
        assert (
            "/Users/original_user/.ssh/shared_project_key.pem" not in output
        )  # Full path hidden
    ...
    def test_safe_path_conversion(self):
        ...
        test_cases = [
            ...
            (
                "/opt/keys/shared.pem",
                "shared.pem",
            ),  # Not under home, show filename only
        ...
        for full_path, expected_safe_path in test_cases:
            ...
            if (
                "C:\\" not in full_path
            ):  # Skip Windows path username check due to path handling differences
                assert not any(
                    username in safe_path for username in ["johndoe", "jane", "bob"]
                )
    ...
    def test_error_formatting_preserves_suggestions(self):
        ...
        error = SSHKeyNotFoundError(
            key_path="/Users/colleague/.ssh/missing_key.pem", service_name="api-tunnel"
        )
    ...
    def test_console_title_appropriate_for_ssh_errors(self):
        ...
        error = SSHKeyNotFoundError(key_path="/Users/user/.ssh/missing.pem")
...
if __name__ == "__main__":
    ...
    errors = [
        SSHKeyNotFoundError(
            key_path="/Users/dev1/.ssh/prod.pem", service_name="prod-db"
        ),
        SSHKeyNotFoundError(
            key_path="/Users/dev1/.ssh/staging.pem", service_name="staging-api"
        ),
    ]
